...
class Intro extends Component {
	render() {
		return (
			<IntroPage>
				<div>
					<img src={logoIntro} alt="logoIntro" />
				</div>
				You can use MyFactomWallet to hold, send, and receive Factoids. You
				don't have a wallet set up yet.
				<IntroSubtext1>
					Choose from the options below to get started
				</IntroSubtext1>
				<Link to={'/createwallet'}>
					<IntroButton>Create New Wallet</IntroButton>
				</Link>
				<Link to={'/wallet/manage/1/send'}>
					<IntroButton>Import</IntroButton>
				</Link>
				<IntroSubtext2>
